...
struct Lambertian <: Material
    ...
    Lambertian() = new(vec(zeros(Float64, 1, 3)))
...
function set_face_normal(hit_record::Hit_record, ray::Ray, outward_normal::Array{Float64, 1})
...
struct Sphere <: Hittable
    ...
    Sphere() = new(vec(zeros(Float64, 1, 3)), 1., Lambertian())
...
function scatter(material::Material, ray_in::Ray, hit_record::Hit_record, attenuation::Array{Float64, 1}, scattered::Ray)
    return false
end

function scatter(material::Lambertian, ray_in::Ray, hit_record::Hit_record, attenuation::Array{Float64, 1}, scattered::Ray)
    ...
    attenuation[1] = material.albedo[1]
    attenuation[2] = material.albedo[2]
    attenuation[3] = material.albedo[3]
    return true
end
...
struct Metal <: Material
    ...
    Metal() = new(vec(zeros(Float64, 1, 3)), 0.)
    Metal(albedo, fuzz) = new(albedo, fuzz)
end

function scatter(material::Metal, ray_in::Ray, hit_record::Hit_record, attenuation::Array{Float64, 1}, scattered::Ray)
...
function scatter(material::Dielectric, ray_in::Ray, hit_record::Hit_record, attenuation::Array{Float64, 1}, scattered::Ray)
    attenuation[1] = 1.0
    attenuation[2] = 1.0
    attenuation[3] = 1.0
